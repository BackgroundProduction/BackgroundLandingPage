...
export const hy: Content = {
  ...
  hero: {
    ...
    title: "Մենք չենք կազմակերպում իվենթներ։ Ստեղծում ենք պահեր։",
    titleParts: ["Մենք չենք կազմակերպում իվենթներ։ Ստեղծում ենք ", "պահեր", ""],
    sub: "Մեկ գործընկեր՝ ամբողջ ճանապարհին. ռազմավարություն, բեմ, ձայն, լույս և կինո։ Համերգներ, գալաներ, ֆորումներ, բացումներ և պետական արարողություններ՝ Հայաստանում, ԱՊՀ-ում և Եվրոպայում։",
  ...
  about: {
    eyebrow: "Մեր մասին",
    heading: "Մեկ թիմ։ Ամեն տեսակի պահ",
    philosophy:
