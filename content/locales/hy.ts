...
export const hy: Content = {
  ...
  clients: [
    ...
    { name: "ՀՀ կառավարություն", logo: "/assets/logos/government-armenia.png" },
    { name: "Հրաձգության եվրոպական կոնֆեդերացիա", logo: "/assets/logos/european-shooting.png" },
    { name: "ԿԳՄՍ նախարարություն", logo: "/assets/logos/ministry-escs.png" },
    { name: "Ասիական զարգացման բանկ", logo: "/assets/logos/asian-development-bank-seeklogo.png" },
    { name: "COP17 Երևան 2026", logo: "/assets/logos/cop17-yerevan.png" },
    { name: "Tour of Armenia", logo: "/assets/logos/tour-of-armenia.svg" },
    { name: "Սպորտի կառավարման կենտրոն", logo: "/assets/logos/sports-management-center.png" },
